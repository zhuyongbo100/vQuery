~function(){
    //->tween算法，t: curTime， b:begin， c:change(target-begin)， d:duration
    var tween = {
        //匀速
    ...
    //->tween支持以下的情况
    //1)pass->number：0->Linear 1->Circ.easeInOut 2->Elastic.easeOut 3->Back.easeOut 4->Bounce.easeOut 5->Expo.easeIn
    //2)pass->array：["Elastic","easeOut"]) ->tween.Elastic.easeOut
    //3)undefined:tween.Linear

    //@arguments:
    // curEle:当前元素,target：目标点的位置，是一个{}，duration:动画运动时间,effect:tween动画库一种效果,callback:回调函数
